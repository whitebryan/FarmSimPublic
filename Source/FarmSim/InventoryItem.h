...
public:
	...
	int maxLength = 25;
	UPROPERTY(EditAnywhere, BlueprintReadOnly, meta = (Tooltip = "Minimum weight the fish can drop at in cm"))
	int minWeight = 5;
	UPROPERTY(EditAnywhere, BlueprintReadOnly, meta = (Tooltip = "Maximum weight the fish can drop at in cm"))
	int maxWeight = 10;
};
